...
<div class="container"> 
	<div class="alert alert-success no-print" role="alert">
		<p>Your guest has been successfully registered.  Please share or print the below information with your guest.  Your guest will be able to use the same username and password below to access the wireless as well as log on any district computer.</p>
	</div>
	<div class="alert alert-warning no-print" role="alert"> 
		<p>By registering your guest you assume full responsibility for their actions while using the wireless and/or district computer(s).<br />
		In addition, by using this account and connecting to the wireless network your guest agrees to accept and abide by the terms set forth in the Acceptable Use Policy.</p>
	</div>
</div>
<div class="container">
	...
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Guest Location:</p></strong>
		</div>
		<div class="col-xs-8">
	...
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Purpose of Access:</p></strong>
		</div>
		<div class="col-xs-8">
			<?php echo "<p>".$_POST['purpose']."</p>";?> 
		</div>
	</div>
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Staff Sponsor:</p></strong>
		</div>
		<div class="col-xs-8">
			<?php echo "<p>$sponsor</p>";?> 
		</div>
	</div>
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Guest Username:</p></strong>
		</div>
		<div class="col-xs-8">
			<?php echo "<p>$account</p>";?>
		</div>
	</div>
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Guest Password:</p></strong>
		</div>
		<div class="col-xs-8">
			<?php echo "<p>$pwdtxt</p>";?>
		</div>
	...
	<div class="form-group row">
		<div class="col-xs-3">
			<strong><p>Expiration:</p></strong>
		</div>
		<div class="col-xs-8">
			<?php echo "<p>This account will expire on: ".$dt->format('m-d-Y H:i:s')."</p>";?>
		</div>
	</div>
	<div class="alert alert-info" role="alert"> 
		<p>If you have any questions, concerns, or need further assistance, please submit a helpdesk ticket or call the helpdesk line at extension 5511.</p>
	</div>
...
<div class="container"> 
	<div class="alert alert-danger no-print" role="alert">
		<p>Error: This username already exists. Please try again with a different username.</p>
	</div>
</div>   
<?php	
	...
	<form action="index.php?registered" method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<p><small class="text-muted">Primary location for reference. Your guest is not limited to using their account in this location.</small></p>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<select name="length" value='' class="form-control">
					...
					'<option id="disabledInput"  value="" disabled>Please submit a helpdesk ticket for longer durations.</option>',"\n";
					} ?>
				</select>
				<p><small class="text-muted">Your guest's account will automatically be disabled at the end of this requested duration.</small></p>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<p><small class="text-muted">Maximum 13 characters.  All guest accounts will have a prefix of hpsgst_ added automatically.</small></p>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<p><small class="text-muted">Minimum 5 characters.</small></p>
			</div>
		</div>
		<div class="form-group row">
